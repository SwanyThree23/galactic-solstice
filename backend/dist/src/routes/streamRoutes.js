...
router.get('/:id/metrics', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.post('/:id/multi-stream', auth_1.authMiddleware, async (req, res) => {
    try {
...
router.post('/:id/ai-highlights', auth_1.authMiddleware, async (req, res) => {
    try {
